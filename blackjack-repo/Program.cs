namespace blackjack_repo
{
    internal class Program
    {
            static void Main(string[] args)
            {
                ...
                int welkSpel = Convert.ToInt32(Console.ReadLine());
            ...
            public static void spelRegels()
            {
                ...
                int welkeRegels = Convert.ToInt32(Console.ReadLine());
                    ...
                    switch (welkeRegels)
                    {
                        ...
                        case 2:
                            ...
                            while (subregelsGekozen == false)
                            {
                                ...
                                int Subregels = Convert.ToInt32(Console.ReadLine());
                                switch (Subregels)
                                {
                                    case 1:
